    ...
    <div class="card-body">
        <div class="form-row">
            <div class="col-md-3 mb-3">
                ...
                <input type="text" name="kode_barang_keluar" id="kode_barang_keluar" class="form-control" placeholder="" value="{{ $kode_barang_keluar }}" readonly>
            </div>
            @if(isset($id_stok))
                ...
                @if($stok->count() > 0)
                 ...
                 <tr>
                      ...
                      <td>
                        ...
                        <input type="number" name="stok_keluar[]" id="stok_keluar" class="form-control" placeholder="0" value="0">
                      </td>
                 </tr>
                 @endforeach
                 @else
 ...
 <script type="text/javascript">
    $(document).ready(function(){
        $("select[name='kategory']").change(function(e){
            const id = $(this).val();
            const url = "{{ url('barangkeluar/kategory') }}/"+id;
