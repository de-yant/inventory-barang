          ...
          <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex justify-content-between">
                <div class="iq-card-header-toolbar d-flex align-items-center">
                    <div class="iq-card-header-toolbar d-flex align-items-center">
                        {{-- kembali --}}
                        <a href="{{ url('/barangmasuk') }}" class="btn btn-primary m-1 p-2"><i class="ri-arrow-go-back-line mr-1"></i>Kembali</a>
                        {{-- cetak --}}
                        <a href="{{ url('barangmasuk/printpdf') }}" class="btn btn-danger m-1 p-2"><i class="ri-file-pdf-line mr-1"></i>PDF</a>
                    </div>
                </div>
            </div>
             <div class="card-body">
